...
\begin{itemize}
  \item Research focus on Software-defined Networking, Programmable Network and In-network Computing
...
\begin{itemize}
  \item Excellent Graduation Thesis
\end{itemize}
...
\begin{enumerate}
  ...
  \item \textbf{J. Fang}, G. Zhao, H. Xu, C. Wu, Z. Yu, \textit{GRID: Gradient Routing with In-network Aggregation for Distributed Training}, IEEE/ACM Transactions on Networking (\textbf{ToN})
  \item \textbf{J. Fang}, G. Zhao, H. Xu, H. Tu, H. Wang, \textit{Reveal: Robustness-Aware VNF Placement and Request Scheduling in Edge Clouds}, Computer Networks (\textbf{ComNet})
\end{enumerate}

\section{Experience}

\datedsubsection{\textbf{Simulating network faults with programmable dataplane}}{Suzhou, China}
\datedsubsection{\textit{Main Developer}}{2022.12-present}
\begin{itemize}
