...
\datedsubsection{\textbf{下一代云原生 SDN 平台开发测试}}{华为美研院 (Futurewei), \textit{远程}}
...
\datedsubsection{\textbf{基于可编程网络实现精准模拟网络故障}}{苏州}
...
\datedsubsection{\textbf{面向边缘云考虑鲁棒性的虚拟网络功能部署算法}}{合肥}
...
\datedsubsection{\textbf{基于 FPGA 高层次综合实现 LSTM 模型}}{湖南}
